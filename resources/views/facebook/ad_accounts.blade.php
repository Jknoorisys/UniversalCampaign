                            ...
                            @if ($addAccounts)
                                @foreach ($addAccounts as $addAccount )
                                    <tr class="text-center">
                                        <td>{{ $addAccount['account_id'] }}</td>
                                        <td>{{ $addAccount['id'] }}</td>
                                        
                                        <td><a href="{{ url('/facebook/facebook-get-all-campaigns/.$addAccount['account_id']')}}"><i class="fa fa-ellipsis-h" style="font-size:24px"></i></a></td>
                                    </tr>
                                @endforeach 
                            @else
                                <tr class="text-center">
