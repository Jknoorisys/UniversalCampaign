                      ...
                      <div class="row">
                        <div class="col-3">
                          ...
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="google_objective" id="optionsRadios1" value="BRAND_AWARENESS" checked="">
                            <label class="form-check-label" for="optionsRadios1">BRAND AWARENESS</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="google_objective" id="optionsRadios2" value="APP_CONVERSION">
                            <label class="form-check-label" for="optionsRadios2">APP CONVERSION</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="google_objective" id="optionsRadios3" value="APP_INSTALL">
                              <label class="form-check-label" for="optionsRadios3">APP INSTALL</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="google_objective" id="optionsRadios4" value="CATALOG_SALES">
                              <label class="form-check-label" for="optionsRadios4">CATALOG SALES</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="google_objective" id="optionsRadios5" value="ENGAGEMENT">
                        ...
                        <div class="col-3">
                          <label class="mb-2">FB/Instagram</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fb_objective" id="optionsRadios6" value="LEAD_GENERATION" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fb_objective" id="optionsRadios8" value="WEB_CONVERSION">
                                <label class="form-check-label" for="optionsRadios8">WEB CONVERSION</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fb_objective" id="optionsRadios9" value="PROMOTE_STORIES">
                                <label class="form-check-label" for="optionsRadios9">PROMOTE STORIES</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fb_objective" id="optionsRadios10" value="PROMOTE_PLACES">
